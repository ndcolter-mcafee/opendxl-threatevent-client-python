...
VERSION = __import__('dxlthreateventclient').get_version()
RELEASE_NAME = "dxlthreateventclient-python-dist-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlthreateventclient")])
...
print("\nRemoving dxlthreateventclient.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlthreateventclient.egg-info"))
